...
const Trending = () => {
  const trendingTags = ["React", "MaterialUI", "WebDevelopment", "JavaScript", "Coding"];
  return (
    <Paper sx={{ height: "100vh", position:'relative' }}>
      ...
      <Box sx={{mt:2}}>
        <Typography variant="h6" sx={{fontWeight:"bold", mt:1, mb:-2, textAlign:"center", color:"#1876D1"}}>Other Projects</Typography>
      <ProjectSlider/>
      </Box>
      </Box>
      <SocialContact/>
